...
Thank you for choosing to use DriverNote Pro ("the App"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us.
...
## 2. Google Drive API Usage and Limited Use Policy
DriverNote Pro allows you to backup and restore your app data using your personal Google Drive account.
- **What we access:** The App only accesses the specific backup folder it creates (`DriverNote_Backup.json`) in your Google Drive. It does NOT have access to your personal files, photos, or other data.
- **Limited Use:** DriverNote Pro's use and transfer to any other app of information received from Google APIs will adhere to the [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), including the Limited Use requirements.
- We do not share, sell, or transfer your Google Drive data to any third-party services.
